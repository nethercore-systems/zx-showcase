#!/usr/bin/env python3
"""Generate Phantom car mesh.

Output: ../../generated/meshes/phantom.glb

Stealth supercar with dark gray body and green neon.
Run with: blender --background --python phantom.py
"""
import sys
