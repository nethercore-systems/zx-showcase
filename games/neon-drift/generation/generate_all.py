#!/usr/bin/env python3
"""Run all procedural generators for Neon Drift.

Spec-driven workflow:
- Sounds: Uses _generate.py wrapper with spec files from specs/sounds/
- Meshes: Traditional Blender generators (unique geometry)
- Textures: Traditional PIL generators (unique patterns)
