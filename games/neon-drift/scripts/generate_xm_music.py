...
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent.parent /
                       "nethercore-ai-plugins/zx-procgen/skills/xm-writer/scripts"))

from xm_writer import (
    XmModule, XmPattern, XmNote, XmInstrument, XmEnvelope,
    write_xm, validate_xm, note_from_name
)
...
def create_instruments() -> list:
    """Create instruments that map to Neon Drift's synth samples."""
    return [
        XmInstrument(name="synth_kick"),
        XmInstrument(name="synth_snare"),
        XmInstrument(name="synth_hihat"),
        XmInstrument(name="synth_openhat"),
        XmInstrument(name="synth_bass"),
        XmInstrument(name="synth_lead"),
        XmInstrument(name="synth_pad"),
        XmInstrument(name="synth_arp"),
    ]
