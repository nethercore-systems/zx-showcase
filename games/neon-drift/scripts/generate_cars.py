...
@dataclass
class CarSpec:
    """Enhanced car specification with style and features."""
    name: str
    ...
    features: List[str]  # Additional features to add


# Enhanced car specifications with distinct personalities
CARS = [
