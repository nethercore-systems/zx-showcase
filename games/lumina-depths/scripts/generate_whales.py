...
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "..", "assets", "models", "meshes")
...
def main():
    ...
    blue_path = os.path.join(OUTPUT_DIR, "blue_whale.obj")
    ...
    sperm_path = os.path.join(OUTPUT_DIR, "sperm_whale.obj")
