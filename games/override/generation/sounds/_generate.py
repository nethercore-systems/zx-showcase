...
This is the spec-driven sound generator for Override.
It reads .spec.py files from specs/sounds/ and generates WAV files.
"""
import sys
from pathlib import Path

# Add procgen lib to path (shared library at zx-showcase root)
